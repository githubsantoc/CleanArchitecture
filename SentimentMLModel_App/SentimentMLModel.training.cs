...
namespace SentimentMLModel_App
{
    public partial class SentimentMLModel
    {
        public const string RetrainFilePath =  @"C:\Users\jesis maharjan\Downloads\train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=1.212012F,L2Regularization=0.03369973F,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}), labelColumnName:@"sentiment"))      
